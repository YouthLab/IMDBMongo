...
namespace Infrastructure
{
    ...
    public abstract class DomainEntity<T> : IValidatableObject
    {
        ...
        /// </summary>
        /// <returns>
        /// True if the domain entity is transient (i.e. has no identity yet), false otherwise.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// A IEnumerable of ValidationResult. The IEnumerable is empty when the object is in a
        /// valid state.
        /// </returns>
